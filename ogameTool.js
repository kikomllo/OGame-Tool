    ...
    function ResourcesScript() {
        ...
        function localResourceTick() {
            ...
            types.forEach(type => {
                ...
                updateUITimer(type, convSecToTime(seconds)); 
            });
            ...
            for (let pID in empEconomy) {
                ...
                if (pData.timestamp) {
                    ...
                    ui.res.children[0].textContent = compactNumber.format(getLive(pData.metal));
                    ui.res.children[1].textContent = compactNumber.format(getLive(pData.crystal));
                    ui.res.children[2].textContent = compactNumber.format(getLive(pData.deuterium));
                }
